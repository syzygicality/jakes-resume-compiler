...
// trimToDocument drops everything ahead of \begin{document}. The base format
// already holds the preamble, so a submitted one re-runs \documentclass and
// errors with "Two \documentclass or \documentstyle commands".
